...
```{r,echo = FALSE, results = 'asis'}
question <- "**Question 1** | On the last screen of the experiment you have to press space for the experiment to exit. What column in the data generated for any run of the experiment gives you the time taken for a person to press space (the reaction time)?"
